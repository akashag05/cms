...
//     setData(fetchedData);
//     console.log("data in blog file", fetchedData);
//   };
//   useEffect(() => {
//     getData();
//   }, []);
...
//     setform({ ...form, blog_Image: blogImage });
//     e.preventDefault();
...
//       const addData = async () => {
//         api_response = await addBlog(form);
...
//                   </div>
//                   <div className="form-control w-full max-w-xs">
//                     <label className="label">Select Blog Date</label>
//                     <input
//                       type="date"
//                       name="blogDate"
//                       className="file-input file-input-bordered w-full max-w-xs"
...
//                   </div>
//                   <div className="form-control w-full max-w-xs">
//                     <label className="label">Upload Blog PDF</label>
//                     <input
//                       type="file"
//                       name="blogpdf"
//                       accept=".pdf"
